            ...
            <div class="wa-content-full">
              <div class="wa-land-title">
            	...
            	<div class="col-xs-12 col-sm-12 col-lg-12 m20">
                  	...
                  	<form action="submitStandareds" method="post" class="wa-verifier-form">
                  		<div class="row">
                  			...
                  			<div class="col-xs-6 col-sm-6 col-lg-6">
                  				<span class="wa-es-form-row">
                  					<label class="required-field"> Standared Name</label>
                  					<input type="text" id="" name="" value=""  placeholder="Enter subject Name" required class="required-filed">
                  				</span>
                  			</div>
